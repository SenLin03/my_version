                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">PublicConfiguration</div>
                        </div>
                                ...
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"
                                                onclick="openModel(false,'${ctx}/sys/config/create')"><span class="am-icon-plus"></span> ADD
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="config" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:;" onclick="openModel(false,'${ctx}/sys/config/update?id=${config.id}')" title="Modify"><span class="am-icon-pencil"></span></a>
                                                <a href="${ctx}/sys/config/${config.id}/delete?pageNo=${page.pageNo}&pageSize=${page.pageSize}" onclick="return confirm('Are you sure you want to delete the data?', this.href)" title="Delete"><span class="am-text-danger am-icon-trash-o"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    </tbody>
